  ...
  <div>
    <div class="flex flex-col lg:flex-row mb-14">
      <div class="lg:basis-2/3 xl:basis-1/2 relative">
        <h2 class="text-3xl md:text-4xl mb-8 text-gray-dark">
          Wyślij wiadomość
        </h2>
        <div
        ...
        >
          <form ref="form" class="flex flex-wrap gap-5" @submit.prevent>
            ...
            <p class="text-xs md:text-sm text-gray-600 mb-2">
              Twoje dane przetważamy zgodnie z naszą
              <b>polityką prywatności</b>.
            </p>
    ...
    <div class="mb-20">
      <iframe
        class="w-full transition duration-200 saturate-50 hover:saturate-100 saturate-fix"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6689.973248536598!2d18.48130151488644!3d49.93959753847606!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x471156ac33f07cb7%3A0x69c6b203433011df!2s1%20Maja%2065%2C%2044-348%20Skrzysz%C3%B3w!5e0!3m2!1spl!2spl!4v1694704958380!5m2!1spl!2spl"
        width="auto"
        height="450"
        style="border: 0"
        allowfullscreen=""
