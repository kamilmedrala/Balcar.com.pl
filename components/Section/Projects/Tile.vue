<template>
    <li class="group border-gray-light hover:border-gold-light border border-solid transition duration-200">
        <a :href="data.acf?.pdf_file ?? ''" target="_blank" class="flex flex-col h-full">
